...
export function TaskHistory({ student, users, currentUser }: TaskHistoryProps) {
  ...
  const studentTasks = useMemo(() => {
    ...
    // This client-side filter is not ideal for performance on large datasets,
    // but is acceptable for this application's scale.
    // A more scalable solution would involve a more complex query or data duplication.
    return allTasksData
