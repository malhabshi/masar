...
import type { Student, User, Application } from '@/lib/types';
...
export default function ReportsPage() {
    ...
    const studentEmployeeData = useMemo(() => {
        ...
        users.forEach(u => u.civilId && employeeMap.set(u.civilId, u));

        const counts = (students || []).reduce((acc, student) => {
            const employeeName = student.employeeId ? (employeeMap.get(student.employeeId)?.name || 'Unassigned') : 'Unassigned';
